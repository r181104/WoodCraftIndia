...
export function AboutSection() {
  return (
    <section id="about" className="py-20" style={{ background: 'linear-gradient(135deg, #1a1611 0%, #2d1f17 30%, #1f1711 100%)' }}>
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-on-scroll-left">
            <h3 className="font-playfair text-2xl font-bold mb-6" style={{ 
              color: '#f5deb3',
              textShadow: '0 1px 2px rgba(26, 22, 17, 0.4)'
            }}>
              Our Heritage
            </h3>
            <div className="space-y-4" style={{ color: '#deb887' }}>
              <p>
          ...
          <div className="animate-on-scroll-right">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="card-hover transition-all duration-500 border border-amber-400/20" style={{
                ...
                <CardContent className="p-6">
                  ...
                  <h4 className="font-semibold mb-2" style={{ color: '#f5deb3' }}>Master Craftsmen</h4>
                  <p className="text-sm" style={{ color: '#deb887' }}>
              ...
              <Card className="card-hover transition-all duration-500 border border-amber-400/20" style={{
                ...
                <CardContent className="p-6">
                  ...
                  <h4 className="font-semibold mb-2" style={{ color: '#f5deb3' }}>Sustainable Wood</h4>
                  <p className="text-sm" style={{ color: '#deb887' }}>
              ...
              <Card className="card-hover transition-all duration-500 border border-amber-400/20" style={{
                ...
                <CardContent className="p-6">
                  ...
                  <h4 className="font-semibold mb-2" style={{ color: '#f5deb3' }}>Traditional Techniques</h4>
                  <p className="text-sm" style={{ color: '#deb887' }}>
